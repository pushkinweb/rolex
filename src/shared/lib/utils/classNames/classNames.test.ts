...
describe('classNames', () => {
    ...
    test('Test two options true', () => {
        expect(cn('someClassMods', [], { mod1: true, mod2: true })).toBe('someClassMods mod1 mod2')
    })
    test('Test options false', () => {
        expect(cn('someClass', [], { mod1: false, mod2: true })).toBe('someClass mod2')
    })
    test('Test options undefined', () => {
        expect(cn('someClass', [], { mod1: true, mod2: undefined })).toBe('someClass mod1')
    })
})
